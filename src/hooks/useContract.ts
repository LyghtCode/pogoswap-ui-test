...
import POGO_ABI from 'app/constants/abis/pogo.json'
// Chi-gag import new Masterchef ABI
// import POGOCHEF_ABI from 'app/constants/abis/pogochef.json'
import ROUTER_ABI from 'app/constants/abis/router.json'
// Chi-gag import SUSHI_ABI from 'app/constants/abis/sushi.json'
...
// import { POGO_ADDRESS } from '@sushiswap/core-sdk'
...
export function useSushiContract(withSignerIfPossible = true): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId ? SUSHI_ADDRESS[chainId] : undefined, POGO_ABI, withSignerIfPossible)
}
