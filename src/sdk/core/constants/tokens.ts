...
import { POGO_ADDRESS, USD_ADDRESS, USDC_ADDRESS, WETH9_ADDRESS, WNATIVE_ADDRESS, PURRX_ADDRESS } from './addresses'
...
export const SUSHI: ChainTokenMap = {
  [ChainId.ETHEREUM]: new Token(ChainId.ETHEREUM, POGO_ADDRESS[ChainId.ETHEREUM], 18, 'SUSHI', 'SushiToken'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, POGO_ADDRESS[ChainId.ROPSTEN], 18, 'SUSHI', 'SushiToken'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, POGO_ADDRESS[ChainId.RINKEBY], 18, 'SUSHI', 'SushiToken'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, POGO_ADDRESS[ChainId.GÖRLI], 18, 'SUSHI', 'SushiToken'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, POGO_ADDRESS[ChainId.KOVAN], 18, 'SUSHI', 'SushiToken'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, POGO_ADDRESS[ChainId.MATIC], 18, 'SUSHI', 'SushiToken'),
  [ChainId.FANTOM]: new Token(ChainId.FANTOM, POGO_ADDRESS[ChainId.FANTOM], 18, 'SUSHI', 'SushiToken'),
  [ChainId.XDAI]: new Token(ChainId.XDAI, POGO_ADDRESS[ChainId.XDAI], 18, 'SUSHI', 'SushiToken'),
  [ChainId.BSC]: new Token(ChainId.BSC, POGO_ADDRESS[ChainId.BSC], 18, 'POGO', 'PogoToken'),
  [ChainId.ARBITRUM]: new Token(ChainId.ARBITRUM, POGO_ADDRESS[ChainId.ARBITRUM], 18, 'SUSHI', 'SushiToken'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, POGO_ADDRESS[ChainId.AVALANCHE], 18, 'SUSHI', 'SushiToken'),
  [ChainId.OKEX]: new Token(ChainId.OKEX, POGO_ADDRESS[ChainId.OKEX], 18, 'SUSHI', 'SushiToken'),
  [ChainId.HARMONY]: new Token(ChainId.HARMONY, POGO_ADDRESS[ChainId.HARMONY], 18, 'SUSHI', 'SushiToken'),
  [ChainId.HECO]: new Token(ChainId.HECO, POGO_ADDRESS[ChainId.HECO], 18, 'SUSHI', 'SushiToken'),
  [ChainId.CELO]: new Token(ChainId.CELO, POGO_ADDRESS[ChainId.CELO], 18, 'SUSHI', 'SushiToken'),
  [ChainId.MOONRIVER]: new Token(ChainId.MOONRIVER, POGO_ADDRESS[ChainId.MOONRIVER], 18, 'SUSHI', 'SushiToken'),
  [ChainId.FUSE]: new Token(ChainId.FUSE, POGO_ADDRESS[ChainId.FUSE], 18, 'SUSHI', 'SushiToken'),
  [ChainId.TELOS]: new Token(ChainId.TELOS, POGO_ADDRESS[ChainId.TELOS], 18, 'SUSHI', 'SushiToken'),
  [ChainId.MOONBEAM]: new Token(ChainId.MOONBEAM, POGO_ADDRESS[ChainId.MOONBEAM], 18, 'SUSHI', 'SushiToken'),
}

export const POGO: ChainTokenMap = {
  [ChainId.MATIC]: new Token(ChainId.MATIC, POGO_ADDRESS[ChainId.MATIC], 18, 'POGO', 'PogoToken'),
  [ChainId.MATIC_TESTNET]: new Token(
    ChainId.MATIC_TESTNET,
    POGO_ADDRESS[ChainId.MATIC_TESTNET],
    18,
    'POGO',
    'PogoToken'
  ),
...
export const PURRX: ChainTokenMap = {
  [ChainId.BSC]: new Token(ChainId.BSC, PURRX_ADDRESS[ChainId.BSC], 18, 'PURRX', 'PurrNFT'),
}
