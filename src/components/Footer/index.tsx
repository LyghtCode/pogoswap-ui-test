...
import { InstagramIcon, MediumIcon, TelegramIcon, TwitterIcon } from 'app/components/Icon'
        ...
        <div className="grid grid-cols-2 gap-10 pt-8 border-t md:grid-cols-3 lg:grid-cols-6 xs:px-6 border-dark-900">
          <div className="flex flex-col gap-3">
            ...
            <Typography variant="xs" className="text-low-emphesis">
              {i18n._(
                t`PogoSwap is a DEX on the BSC for all crypto and an NFT exchange. We also exchange crypto for fiat to your bank account in the currency of your choice. Low fees and secure.`
              )}
            </Typography>
            <div className="flex items-center gap-4">
              <a href="https://twitter.com/pogoswap" target="_blank" rel="noreferrer">
                <TwitterIcon width={16} className="text-low-emphesis" />
              </a>
              <a href="https://www.instagram.com/pogoswap/" target="_blank" rel="noreferrer">
                <InstagramIcon width={16} className="text-low-emphesis" />
              </a>
              <a href="https://medium.com/@pogoswap" target="_blank" rel="noreferrer">
                <MediumIcon width={16} className="text-low-emphesis" />
              </a>
              <a href="https://t.me/PogoSwap" target="_blank" rel="noreferrer">
