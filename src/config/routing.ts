...
import { ChainId, POGO, PURRX, Token, WNATIVE } from 'sdk/core'
...
export const CUSTOM_BASES: {
  ...
  [ChainId.MATIC]: {
    [MATIC.TEL.address]: [MATIC.POGO, MATIC.AAVE],
  },
}
...
export const PINNED_PAIRS: { readonly [chainId: number]: [Token, Token][] } = {
  [ChainId.ETHEREUM]: [
    // @ts-ignore TYPE NEEDS FIXING
    [POGO[ChainId.ETHEREUM], WNATIVE[ChainId.ETHEREUM]],
    [
  ...
  [ChainId.MATIC]: [
    // @ts-ignore TYPE NEEDS FIXING
    [POGO[ChainId.MATIC], WNATIVE[ChainId.MATIC]],
    // @ts-ignore TYPE NEEDS FIXING
    // [MATIC., WNATIVE[ChainId.MATIC]],
  ],
  [ChainId.MATIC_TESTNET]: [
    // @ts-ignore TYPE NEEDS FIXING
    [POGO[ChainId.MATIC_TESTNET], WNATIVE[ChainId.MATIC_TESTNET]],
  ],
  [ChainId.BSC]: [
    // @ts-ignore TYPE NEEDS FIXING
    [POGO[ChainId.BSC], WNATIVE[ChainId.BSC]],
    // @ts-ignore TYPE NEEDS FIXING
    [PURRX[ChainId.BSC], WNATIVE[ChainId.BSC]],
    // @ts-ignore TYPE NEEDS FIXING
    [PURRX[ChainId.BSC], BSC.USDT],
    // @ts-ignore TYPE NEEDS FIXING
    [PURRX[ChainId.BSC], BSC.USDC],
    // @ts-ignore TYPE NEEDS FIXING
    [POGO[ChainId.BSC], BSC.USDT],
    // @ts-ignore TYPE NEEDS FIXING
    [POGO[ChainId.BSC], BSC.USDC],
  ],
}
