...
// ChiGag update with real token address
export const POGO = new Token(ChainId.BSC, '0xB4da5aB10670F6410Ef3A9351bf6FD58f14E1699', 18, 'POGO', 'PogoToken')
export const PURRX = new Token(ChainId.BSC, '0xd4cadc39c1294a6ce118aa08dced32efadac4a7f', 18, 'PURRX', 'PurrNFT')
