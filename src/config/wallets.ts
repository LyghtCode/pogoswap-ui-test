...
export const getNetworkConnector = (): NetworkConnector => {
  ...
  return (network = new NetworkConnector({
    defaultChainId: defaultChainId ? Number(defaultChainId) : 56,
    urls: RPC,
  }))
}
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo } = {
  ...
  METAMASK_MOBILE: {
    ...
    href: 'https://metamask.app.link/dapp/pogoswap-interface-v2-lyghtcode.vercel.app/',
    color: '#1de8e8',
    mobile: true,
    mobileOnly: true,
  },
  ...
  WALLET_LINK: {
    connector: async () => {
      ...
      return new WalletLinkConnector({
        url: RPC[ChainId.ETHEREUM],
        appName: 'PogoSwap',
        appLogoUrl: 'https://raw.githubusercontent.com/Chigag-Studio/pogo-contracts-v2/main/Artboard%202.jpg',
        darkMode: true,
      })
    },
