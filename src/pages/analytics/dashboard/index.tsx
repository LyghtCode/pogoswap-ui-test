      ...
      farms
        ?.map((farm) => ({
          pair: {
            ...
            type: farm.pair.symbol ? 'Kashi Farm' : 'Pogo Farm',
          },
    ...
    <AnalyticsContainer>
      <Background background="dashboard">
        <div className="grid items-center justify-between grid-cols-1 gap-x-4 gap-y-4 md:grid-cols-2">
          <div>
            <div className="text-3xl font-bold text-high-emphesis">Pogo Analytics</div>
            <div className="">
              Dive deeper in the analytics of Pogo bar,
